...
Page({
    ...
    handleOutterClick:function(event){
    ...
    handleCaptureTap1:function(){
        console.log("handleCaptureTap1")
    },
    handleTap1:function(){
        console.log("handleTap1")
    },

    handleCaptureTap2:function(){
        console.log("handleCaptureTap2")
    },
    handleTap2:function(){
        console.log("handleTap2")
    },

    handleCaptureTap3:function(){
        console.log("handleCaptureTap3")
    },
    handleTap3:function(){
